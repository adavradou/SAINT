...
from loss import nlayerdiscriminator
import torch
...
class Adversarial(nn.Module):
    def __init__(self, args, gan_type):
        ...
        self.gan_k = args.gan_k # this is for helping discriminator/generator learning inbalance, i.e. you can train discriminator gan_k times before training generator onece
        # self.discriminator = discriminator.Discriminator(args, gan_type)
        self.discriminator = nlayerdiscriminator.NLayerDiscriminator(2)
        if gan_type != 'WGAN_GP':
